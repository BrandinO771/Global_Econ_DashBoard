...
def top_ten_five(user_selection):
    ...
    if ( user_selection == 'Inflation'):
            query_var =  econ_1_.Inflation
    if ( user_selection == 'Public_Debtof_GDP'):
            query_var =  econ_1_.Public_Debtof_GDP
    if ( user_selection == 'Income_Tax_Rate'):
            query_var =  econ_1_.Income_Tax_Rate
    if ( user_selection == 'Corporate_Tax_Rate'):
            query_var =  econ_1_.Corporate_Tax_Rate
    if ( user_selection == 'Unemployment'):
...
#     print("complete dict is:", complete_dict) 
    ...
    print("this is jdic", j_complete_dict) 
    return (j_complete_dict)
